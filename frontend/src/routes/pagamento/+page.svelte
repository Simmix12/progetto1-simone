<script>
    ...
    let isMobile = false;
    let showRiepilogo = false; // Per il toggle su mobile
    ...
    <div class="colonna-principale">
        ...
        <section class="dettagli-pagamento card">
            ...
            {#if metodoPagamento === 'carta'}
                <form on:submit|preventDefault={confermaPagamento} class="payment-form">
                    <div class="form-group full-width">
                    ...
                    <button 
                        type="submit" 
                        class="pay-button"
                        disabled={Object.keys(errors).length > 0 || Object.keys(validatedFields).length < 3}
                    >
                        <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor">
            ...
            {:else if metodoPagamento === 'bonifico'}
                <div class="payment-method-info">
                    ...
                    <button class="pay-button bank" on:click={() => goto('/scontrino')}>
...
<style>
    ...
    /* Card comune per tutte le sezioni */
    .card {
        background: var(--colore-sfondo-secondario);
